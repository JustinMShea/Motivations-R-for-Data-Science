...
**First Mile**: _Import_ data and prepare for Analysis. Clean data, ach variable is a column, each observation is a row, and each type of observational unit is a table. Alot of time is spent here.
