...
- What is Data Science and what's a Data Scientist?

- What tools are used in Data Science now? 
...
`Python`'s popularity is due to it's high use in Web site development, DevOps, and the west coast technology industry in general. Technology is the fastest growing sector in the economy at present. Use in web development and fast adaptation in **Data Science** has put it on top.
...
_The industry with the second-highest share of `R` visitors, by a close margin, is healthcare. That probably won't come as a surprise to biostatisticians, since `R` is the tool of choice for many statistical methods necessary for clinical studies and bioinformatics._ (R is mature. [It is used and OK'd by the FDA for drug trials](http://blog.revolutionanalytics.com/2012/06/fda-r-ok.html); Python is not...yet)
...
**David Robinson, Data Scientist at Stack Overflow**
...
I found `R` because I wanted to use the most cutting edge, statistical modeling libraries for available. With over 12,000 packages available beyond base `R`, the community organizes noteworthy and mature approaches by research domain. They can ALL be installed with a few commands.
...
## A Data Science Project {.smaller}
...
Szilard Pfafka: Your data is just not that big...
...
[Source: dataset-sizes-kdnuggets](https://github.com/szilard/dataset-sizes-kdnuggets)
...
## Anscombe and his quartet {.smaller .columns-2}

_"Graphs in Statistical Analysis"_ - F.J. Anscombe
...
## Leo Breiman: Statistical/Machine Learning {.columns-2 .smaller}

Bridges gap between statistics and computer science known as "Statistical Learning". Attempts to rename it "Machine Learning" are perplexing.
...
## Jerome Friedman: Statistical/Machine Learning  

A Gradient Boosting Machine
xgboost Current Kaggle competition winner
...
## 1977: Bell Labs,S, & R {.columns-2 .smaller}
...
Datacamp is good for  R syntax as well as how-tos, compliments traditional education.

Signup for meetups and go. They are free and keep you current.
